...
using App_NavigationPane_Prism.Activation;
...
namespace App_NavigationPane_Prism
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "App_NavigationPane_Prism.ViewModels.{0}ViewModel, App_NavigationPane_Prism", viewType.Name.Substring(0, viewType.Name.Length - 4));
