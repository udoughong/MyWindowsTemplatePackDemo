...
using App_NavigationPane_Prism.Behaviors;
using App_NavigationPane_Prism.Services.Ink;
...
namespace App_NavigationPane_Prism.Views
{
    ...
    {
        private InkDrawPictureViewModel ViewModel => DataContext as InkDrawPictureViewModel;
