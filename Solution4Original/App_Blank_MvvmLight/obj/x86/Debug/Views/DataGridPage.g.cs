#pragma checksum "D:\Users\udoug\source\repos\MyWindowsTemplatePackDemo\Solution4Original\App_Blank_MvvmLight\Views\DataGridPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "FDF0A8F0D39991953348851ABC54BD89"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace App_Blank_MvvmLight.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class DataGridPage_obj1_Bindings :
            ...
            IDataGridPage_Bindings
        {
            private global::App_Blank_MvvmLight.Views.DataGridPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::App_Blank_MvvmLight.Views.DataGridPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::App_Blank_MvvmLight.Views.DataGridPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel(global::App_Blank_MvvmLight.ViewModels.DataGridViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
