...
using App_NavigationPane_MvvmBasic.EventHandlers.Ink;
using App_NavigationPane_MvvmBasic.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace App_NavigationPane_MvvmBasic.Services.Ink
{
