...
using App_HorizontalNavigationPane_MvvmLight.EventHandlers.Ink;
using App_HorizontalNavigationPane_MvvmLight.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace App_HorizontalNavigationPane_MvvmLight.Services.Ink
{
