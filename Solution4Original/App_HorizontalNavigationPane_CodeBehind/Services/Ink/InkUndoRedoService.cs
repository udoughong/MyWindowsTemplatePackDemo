...
using App_HorizontalNavigationPane_CodeBehind.EventHandlers.Ink;
using App_HorizontalNavigationPane_CodeBehind.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace App_HorizontalNavigationPane_CodeBehind.Services.Ink
{
