...
using App_NavigationPane_CaliburnMicro.EventHandlers.Ink;
using App_NavigationPane_CaliburnMicro.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace App_NavigationPane_CaliburnMicro.Services.Ink
{
