...
using App_HorizontalNavigationPane_MvvmBasic.EventHandlers.Ink;
using App_HorizontalNavigationPane_MvvmBasic.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace App_HorizontalNavigationPane_MvvmBasic.Services.Ink
{
