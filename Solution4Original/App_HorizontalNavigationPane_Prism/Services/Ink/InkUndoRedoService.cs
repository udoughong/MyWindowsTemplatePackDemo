...
using App_HorizontalNavigationPane_Prism.EventHandlers.Ink;
using App_HorizontalNavigationPane_Prism.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace App_HorizontalNavigationPane_Prism.Services.Ink
{
