...
using App_HorizontalNavigationPane_Prism.Activation;
...
namespace App_HorizontalNavigationPane_Prism
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "App_HorizontalNavigationPane_Prism.ViewModels.{0}ViewModel, App_HorizontalNavigationPane_Prism", viewType.Name.Substring(0, viewType.Name.Length - 4));
