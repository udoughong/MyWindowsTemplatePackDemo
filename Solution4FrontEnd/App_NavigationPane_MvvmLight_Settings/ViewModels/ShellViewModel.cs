...
using App_NavigationPane_MvvmLight_Settings.Helpers;
using App_NavigationPane_MvvmLight_Settings.Services;
using App_NavigationPane_MvvmLight_Settings.Views;
...
namespace App_NavigationPane_MvvmLight_Settings.ViewModels
{
